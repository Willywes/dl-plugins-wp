...
const ThemeGenerator = {
    ...
    bindEvents: () => {
        $(document).on('click', '.theme-generator .theme-generator__button', function (e) {
            e.preventDefault();
...
const getSettings = () => {
    const settings = localStorage.getItem('theme-generator-settings');
...
const resetSettings = () => {
    localStorage.removeItem('theme-generator-settings');
}
